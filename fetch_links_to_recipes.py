...
def fetch_links(category,header,df_rec_links,q):
...
df_rec_links=fetch_links(master_cat,'master ',df_rec_links,len(df_rec_links)+1)
df_rec_links=fetch_links(cat,'',df_rec_links,len(df_rec_links)+1)
